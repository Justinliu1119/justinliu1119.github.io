...
author_profile: true
excerpt: "Selected papers and manuscripts in multi-agent systems, cyber-physical systems, and embodied AI."
---

Selected papers and manuscripts in multi-agent systems, cyber-physical systems, and embodied AI.
...
[[Paper](https://arxiv.org/abs/2511.17915)]

Simon Zhan<sup>*</sup>, **Yao Liu**<sup>*</sup>, Philip Wang<sup>*</sup>, Zinan Wang, Qineng Wang, Zhian Ruan, Xiangyu Shi, Xinyu Cao, Frank Yang, Kangrui Wang, Huajie Shao, Manling Li, and Qi Zhu.  
...
**"Predictive Modeling in AUV Navigation: A Perspective from Kalman Filtering."** *arXiv preprint arXiv:2603.27422*.  
...
C. Chen<sup>†</sup>, **Yao Liu**<sup>†</sup>, J. Yang<sup>†</sup>, Z. Yang<sup>†</sup>, and Yinyu Ye.  
